...
let {isValidPayload,validateSchema}=require('./utils');
class DarajaSDK {
        /**
    ...
    async stkPush(payload){
        ...
        const {StkPushSchema}=require("./resources/schema/StkPushSchema");
        isValidPayload(payload);
        validateSchema(payload,StkPushSchema,this.config);
    ...
    async b2bExpressCheckout(payload){
        const {b2bExpressCheckout}=require('./resources/b2bExpressCheckout');
         const {B2BExpressCheckoutSchema}=require("./resources/schema/B2BExpressCheckout");
        isValidPayload(payload);
        validateSchema(payload,B2BExpressCheckoutSchema,this.config);
        const headers = await this._getAuthorizedHeaders();
    ...
    async b2cPaymentRequest(payload){
        ...
        const {b2cPaymentrequest}=require('./resources/b2c');
         const {B2CPaymentRequsetSchema}=require("./resources/schema/B2CPaymentRequestSchema");
        isValidPayload(payload);
        validateSchema(payload,B2CPaymentRequsetSchema,this.config);
        const headers = await this._getAuthorizedHeaders();
    ...
    async billManagerOptIn(payload){
        ...
        const {billManagerOptIn}=require('./resources/billManager');
         const {BillManagerOptInSchema}=require("./resources/schema/BillManagerSchema");
        isValidPayload(payload);
        validateSchema(payload,BillManagerOptInSchema,this.config);
        const headers = await this._getAuthorizedHeaders();
    ...
    async billManagerSingleInvoicing(payload){
        ...
        const {billManagerSingleInvoicing}=require('./resources/billManager');
         const {BillManagerSingleInvoicingSchema}=require("./resources/schema/BillManagerSchema");
        isValidPayload(payload);
        validateSchema(payload,BillManagerSingleInvoicingSchema,this.config);
        const headers = await this._getAuthorizedHeaders();
    ...
    async billManagerUpdateOptIn(payload){
        ...
        const {BillManagerUpdateOptInSchema}=require("./resources/schema/BillManagerSchema");
        isValidPayload(payload)
        validateSchema(payload,BillManagerUpdateOptInSchema,this.config);
        const headers = await this._getAuthorizedHeaders();
    ...
    async billManagerCancelSingleInvoice(payload){
        ...
        const {BillManagerCancelSingleInvoiceSchema}=require("./resources/schema/BillManagerSchema");
        isValidPayload(payload);
        validateSchema(payload,BillManagerCancelSingleInvoiceSchema,this.config);
        const headers = await this._getAuthorizedHeaders();
    ...
    async billManagerReconcoilliation(payload){
        ...
        const {BillManagerReconsiliationSchema}=require('./resources/schema/BillManagerSchema');
        isValidPayload(payload);
        validateSchema(payload,BillManagerReconsiliationSchema,this.config);
        const headers = await this._getAuthorizedHeaders();
    ...
    async businessBuyGoods(payload){
        ...
        const {BusinessBuyGoodsSchema}=require("./resources/schema/BusinessBuyGoodsSchema");
        isValidPayload(payload)
        validateSchema(payload,BusinessBuyGoodsSchema,this.config);
        const headers = await this._getAuthorizedHeaders();
    ...
    async businessPayBill(payload){
        ...
        const {BusinessPayBillSchema}=require('./resources/schema/BusinessPayBillSchema');
         isValidPayload(payload)
         validateSchema(payload,BusinessPayBillSchema,this.config);
        const headers = await this._getAuthorizedHeaders();
    ...
    *
    ...
    async c2bRegisterURL(payload){
        ...
        const {C2BRegisterURLSchema}=require('./resources/schema/C2BRegisterURLSchema');
        isValidPayload(payload);
        validateSchema(payload,C2BRegisterURLSchema,this.config);
        const headers = await this._getAuthorizedHeaders();
    ...
    async dynamicQr(payload){
        ...
        const {DynamicQrCodeSchema}=require('./resources/schema/DynamicQrcodeSchema');
        isValidPayload(payload);
        validateSchema(payload,DynamicQrCodeSchema,this.config);
        const headers = await this._getAuthorizedHeaders();
    ...
    async ratiba(payload){
        ...
        const {MPesaRatibaSchema}=require('./resources/schema/MpesaRatibaSchema');
         isValidPayload(payload);
         validateSchema(payload,MPesaRatibaSchema,this.config);
        const headers = await this._getAuthorizedHeaders();
    ...
    async reverse(payload){
        try {
            ...
            const {ReversalsSchema}=require('./resources/schema/ReversalsSchema');
            isValidPayload(payload);
            validateSchema(payload,ReversalsSchema,this.config);
            const headers = await this._getAuthorizedHeaders();
    ...
    async taxRemittance(payload){
        try {
            ...
            const {TaxRemittanceSchema}=require('./resources/schema/TaxRemmitanceSchema');
            isValidPayload(payload);
            validateSchema(payload,TaxRemittanceSchema,this.config);
            const headers = await this._getAuthorizedHeaders();
    ...
    async transactionStatus(payload){
        ...
        const {TransactionStatusSchema}=require('./resources/schema/TransactionStatusSchema');
         isValidPayload(payload);
         validateSchema(payload,TransactionStatusSchema,this.config);
        const headers = await this._getAuthorizedHeaders();
    ...
    async expressQuery(payload){
        ...
        const {ExpressQuerySchema}=require('./resources/schema/ExpressQuerySchema');
        isValidPayload(payload);
        validateSchema(payload,ExpressQuerySchema,this.config);
        const headers=await this._getAuthorizedHeaders();
    ...
    async accountBalance(payload){
        ...
        const {AccountBalanceSchema}=require('./resources/schema/AccountBalanceSchema');
         isValidPayload(payload);
         validateSchema(payload,AccountBalanceSchema,this.config);
        const headers=await this._getAuthorizedHeaders();
    ...
    async b2cAccountTopUp(payload){
        ...
        const {B2CAccountTopUpSchema}=require('./resources/schema/B2CAccountTopup');
        isValidPayload(payload);
        validateSchema(payload,B2CAccountTopUpSchema,this.config);
        const headers=await this._getAuthorizedHeaders();
